...
import { Select, NativeSelect, useForm } from '../../component/form';
...
모든 폼은 `useForm`을 통해 `FormControl`을 생성해 사용할 수 있습니다. select는 `width`와 `label`의 설정을 권장합니다. 

```tsx
import { useForm, Select } from '@seolim/react-ui/form';
...
const Component = () => {
  ...
  */
  ...
  const control = useForm<any, HTMLDivElement>({
    validator, valueSet
  });
...
export const smallTemplate = () => {
  ...
  return <Select scale="small" control={control} width={120} />
}
export const mediumTemplate = () => {
  const control = useForm({
    validator, valueSet
  });
  return <Select scale="medium" control={control} width={120} />
}
export const largeTemplate = () => {
  const control = useForm({
    validator, valueSet
  });
  return <Select scale="large" control={control} width={120} />
}
export const bigTemplate = () => {
  const control = useForm({
    validator, valueSet
  });
  return <Select scale="big" control={control} width={120} />
}
...
export const ableTemplate = () => {
  ...
  return <Select disabled={false} control={control} width={120} />
}
export const disableTemplate = () => {
  const control = useForm({
    validator, valueSet
  });
  return <Select disabled={true} control={control} width={120} />
}
...
export const labelTemplate = () => {
  ...
  return <Select control={control} width={120} label={label}/>
}
...
export const validTemplate = () => {
  ...
  return <Select control={control} width={120}/>
};
...
```tsx
import { useForm, NativeSelect } from '@seolim/react-ui/form';
...
const Component = () => {
  ...
  const control = useForm<any, HTMLSelectElement>({
    validator, valueSet
  });
...
export const nativeTemplate = () => {
  ...
  return <NativeSelect control={control} width={120}/>
}
